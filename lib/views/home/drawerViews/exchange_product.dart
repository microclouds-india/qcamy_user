...
class ExchangeProduct extends StatefulWidget {
  const ExchangeProduct({Key? key}) : super(key: key);
          ...
          children: [
            ...
            FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  return accessoriesData.accessoriesModel.data.isNotEmpty ? Align(
            ...
            //submit button
            Consumer<ExchangeProductNotifier>(builder: (context, data, _) {
              return data.isLoading ? const Padding(
                  ...
                  child: BookingButton(
                    ...
                    onTap: () async {
                      if (_nameController.text.isNotEmpty &&
                        ...
                        try {
                          await data.submitExchangeProduct(
                            token: token!,
                        ...
                        try {
                          if (data.exchangeProductModel.status == "200") {
                            // showDialog(
                            //     context: context,
                            //     builder: ((context) {
