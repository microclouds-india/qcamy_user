...
class ExchangeProductNetworking {
  static const String urlENDPOINT =
      "https://cashbes.com/photography/apis/exchange_product";

  final client = http.Client();

  late ExchangeProductModel exchangeProductModel;

  Future<ExchangeProductModel> exchangeProduct({
    ...
    try {
      ...
      requestResponse.stream.transform(utf8.decoder).listen((value) {
        ...
        if (requestResponse.statusCode == 200) {
          exchangeProductModel = ExchangeProductModel.fromJson(jsonResponse);
          // print(jsonResponse);
        }
      });
